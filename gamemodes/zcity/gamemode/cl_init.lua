...
function GM:ScoreboardShow()
    ...
    scoreBoardMenu.PaintOver = function(self,w,h)
        ...
        local txt = (CurrentRound() and CurrentRound().PrintName or zb.CROUND) .. " " .. (CurrentRound() and CurrentRound().TypeNames and CurrentRound().TypeNames[CurrentRound().Type] or "")
    ...
    for i, ply in player.Iterator() do -- надо это говно переделать.
        ...
        soundButton:DockMargin(5,10,100,10)
